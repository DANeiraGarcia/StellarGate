...
mod tests {
    ...
    #[test]
    fn normalize_legacy_space_separator() {
        assert_eq!(normalize_ts("2026-04-29 15:00:00"), "2026-04-29T15:00:00Z");
    }

    #[test]
    fn normalize_legacy_t_no_z() {
        assert_eq!(normalize_ts("2026-04-29T15:00:00"), "2026-04-29T15:00:00Z");
    }

    #[test]
    fn already_correct_is_unchanged() {
        assert_eq!(normalize_ts("2026-04-29T15:00:00Z"), "2026-04-29T15:00:00Z");
    }

    #[test]
    fn already_has_offset_is_unchanged() {
        assert_eq!(normalize_ts("2026-04-29T15:00:00+00:00"), "2026-04-29T15:00:00+00:00");
    }

    #[test]
    fn unexpected_value_returned_unchanged() {
        assert_eq!(normalize_ts("not-a-date"), "not-a-date");
    }
}
